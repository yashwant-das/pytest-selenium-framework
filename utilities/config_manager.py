...
class ConfigManager:
    ...
    def get_browser_config(self, browser: Optional[str] = None) -> Dict[str, Any]:
        ...
        Returns:
            dict: Browser configuration. If browser is specified, returns that browser's config.
                 If None, returns all browser configurations.
        """
        if browser:
    ...
    def get_env_config(self, env: Optional[str] = None) -> Dict[str, Any]:
        ...
        return self._env_config.get("default", {})
    ...
    def get_all_configs(self) -> Dict[str, Any]:
        """Get all configurations in a single dict (for backward compatibility).
        
        Returns:
            dict: Dictionary with keys: test_data, env_config, browser_config
        """
        return {
